...
IO_OUTPUT(IOZ1Step, ORIG_E2_STEP_PIN)
IO_OUTPUT_INVERTED(IOZ1Dir, ORIG_E2_DIR_PIN)
IO_OUTPUT_INVERTED(IOZ1Enable, ORIG_E2_ENABLE_PIN)

// Z2 Motor
IO_OUTPUT(IOZ2Step, ORIG_E3_STEP_PIN)
IO_OUTPUT_INVERTED(IOZ2Dir, ORIG_E3_DIR_PIN)
IO_OUTPUT_INVERTED(IOZ2Enable, ORIG_E3_ENABLE_PIN)
